...
/* Examples to retrieve the constants:
    char   strff[SINGLE_STRING_SIZE];
    strcpy(strff, "Acceleration due to earth's gravity\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "EARTH-ACCELERATION\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "Avogadro's number\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "AVOGADRO-NUMBER\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "Boltzmann's constant\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "BOLTZMANN-CONSTANT\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "Coulomb's constant\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "COULOMB-CONSTANT\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "Electron charge magnitiude\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "ELECTRON-CHARGE\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "Permeability of free space\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "FREE-PERMEABILITY\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "Permittivity of free space\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "FREE-PERMITTIVITY\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "Pi\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "PI\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "Planck's constant\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "PLANCK-CONSTANT\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "Mass of electron\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "ELECTRON-MASS\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "Mass of neutron\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "NEUTRON-MASS\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "Mass of proton\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "PROTON-MASS\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "Speed of light in vacuum\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "SPEED-OF-LIGHT\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "Universal gravitational constant\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "GRAVITATIONAL-CONSTANT\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "Universal gas constant\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
    strcpy(strff, "UNIVERSAL-GAS-CONSTANT\0");
    cout << "The constant " << strff << " is " << cget_the_constant_value_of(strff) << endl;
*/
